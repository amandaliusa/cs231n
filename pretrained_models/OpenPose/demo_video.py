    ...
    def __init__(self, output_file, input_fps, input_framesize, input_pix_fmt,
        ...
        self.ff_proc = (
            ...
            .input('pipe:',
                   ...
                   r=input_fps)
            .output(output_file, pix_fmt=input_pix_fmt, vcodec=input_vcodec, vf="pad=ceil(iw/2)*2:ceil(ih/2)*2")
            .overwrite_output()
...
while(cap.isOpened()):
    ...
    # break after 1 frame 
    # uncomment this line to process just one frame for proof of concept
    #break
